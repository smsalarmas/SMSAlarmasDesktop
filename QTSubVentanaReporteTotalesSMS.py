...
# Form implementation generated from reading ui file 'QTSubVentanaReporteTotalesSMS.ui'
#
...
class Ui_SubVentanaReporteTotalesSMS(object):
    def setupUi(self, SubVentanaReporteTotalesSMS):
        SubVentanaReporteTotalesSMS.setObjectName(_fromUtf8("SubVentanaReporteTotalesSMS"))
        SubVentanaReporteTotalesSMS.resize(848, 420)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/SMSTotales2.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SubVentanaReporteTotalesSMS.setWindowIcon(icon)
        SubVentanaReporteTotalesSMS.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout = QtGui.QGridLayout(SubVentanaReporteTotalesSMS)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.widget_Grafico = QtGui.QWidget(SubVentanaReporteTotalesSMS)
        ...
        self.frame = QtGui.QFrame(SubVentanaReporteTotalesSMS)
...
"color: rgb(255, 255, 255);"))
        ...
        self.groupBox = QtGui.QGroupBox(SubVentanaReporteTotalesSMS)
        ...
        self.retranslateUi(SubVentanaReporteTotalesSMS)
        QtCore.QMetaObject.connectSlotsByName(SubVentanaReporteTotalesSMS)

    def retranslateUi(self, SubVentanaReporteTotalesSMS):
        SubVentanaReporteTotalesSMS.setWindowTitle(_translate("SubVentanaReporteTotalesSMS", "Reporte de SMS Totales por Cliente", None))
        self.label.setText(_translate("SubVentanaReporteTotalesSMS", "Reporte de Cantidad de SMS por Cliente", None))
        self.groupBox.setTitle(_translate("SubVentanaReporteTotalesSMS", "Reporte Detallado", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaReporteTotalesSMS", "ID", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(1)
        item.setText(_translate("SubVentanaReporteTotalesSMS", "Nombre", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(2)
        item.setText(_translate("SubVentanaReporteTotalesSMS", "Cant SMS", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(3)
        item.setText(_translate("SubVentanaReporteTotalesSMS", "Acciones", None))
        self.label_3.setText(_translate("SubVentanaReporteTotalesSMS", "Desde:", None))
        self.label_4.setText(_translate("SubVentanaReporteTotalesSMS", "Hasta:", None))
        self.pushButton_GenerarReporte.setText(_translate("SubVentanaReporteTotalesSMS", "Buscar", None))
        self.label_2.setText(_translate("SubVentanaReporteTotalesSMS", "Busqueda:", None))
        self.pushButton_PDF.setText(_translate("SubVentanaReporteTotalesSMS", "PDF", None))
        self.pushButton_XLS.setText(_translate("SubVentanaReporteTotalesSMS", "XLS", None))
