...
# Form implementation generated from reading ui file 'QTSubVentanaSubTiposEquipos.ui'
#
...
class Ui_SubVentanaEquiposSubTipos(object):
    def setupUi(self, SubVentanaEquiposSubTipos):
        SubVentanaEquiposSubTipos.setObjectName(_fromUtf8("SubVentanaEquiposSubTipos"))
        SubVentanaEquiposSubTipos.resize(338, 505)
        SubVentanaEquiposSubTipos.setMinimumSize(QtCore.QSize(338, 505))
        SubVentanaEquiposSubTipos.setMaximumSize(QtCore.QSize(338, 505))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/Departamentos3.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SubVentanaEquiposSubTipos.setWindowIcon(icon)
        SubVentanaEquiposSubTipos.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout_2 = QtGui.QGridLayout(SubVentanaEquiposSubTipos)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.groupBox_4 = QtGui.QGroupBox(SubVentanaEquiposSubTipos)
        ...
        self.gridLayout_3.addWidget(self.tableWidget_Lista, 2, 0, 1, 3)
        ...
        self.comboBox_Tipo = QtGui.QComboBox(self.groupBox_4)
        self.comboBox_Tipo.setObjectName(_fromUtf8("comboBox_Tipo"))
        self.comboBox_Tipo.addItem(_fromUtf8(""))
        self.gridLayout_3.addWidget(self.comboBox_Tipo, 1, 1, 1, 1)
        self.gridLayout_2.addWidget(self.groupBox_4, 0, 0, 1, 1)
        self.groupBox_Datos = QtGui.QGroupBox(SubVentanaEquiposSubTipos)
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.lineEdit_Nombre)
        ...
        self.comboBox_TipoEquipo = QtGui.QComboBox(self.groupBox_Datos)
        self.comboBox_TipoEquipo.setObjectName(_fromUtf8("comboBox_TipoEquipo"))
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.comboBox_TipoEquipo)
        self.gridLayout_2.addWidget(self.groupBox_Datos, 1, 0, 1, 1)

        self.retranslateUi(SubVentanaEquiposSubTipos)
        QtCore.QMetaObject.connectSlotsByName(SubVentanaEquiposSubTipos)
        SubVentanaEquiposSubTipos.setTabOrder(self.lineEdit_Buscar, self.tableWidget_Lista)
        SubVentanaEquiposSubTipos.setTabOrder(self.tableWidget_Lista, self.pushButton_Agregar)
        SubVentanaEquiposSubTipos.setTabOrder(self.pushButton_Agregar, self.lineEdit_Nombre)
        SubVentanaEquiposSubTipos.setTabOrder(self.lineEdit_Nombre, self.pushButton_Guardar)
        SubVentanaEquiposSubTipos.setTabOrder(self.pushButton_Guardar, self.pushButton_Borrar)
        SubVentanaEquiposSubTipos.setTabOrder(self.pushButton_Borrar, self.pushButton_Cancelar)

    def retranslateUi(self, SubVentanaEquiposSubTipos):
        SubVentanaEquiposSubTipos.setWindowTitle(_translate("SubVentanaEquiposSubTipos", "Administrar Sub Tipos de Equipos", None))
        self.groupBox_4.setTitle(_translate("SubVentanaEquiposSubTipos", "Lista de Sub Tipos de Equipos", None))
        item = self.tableWidget_Lista.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaEquiposSubTipos", "Descripcion", None))
        self.pushButton_Agregar.setToolTip(_translate("SubVentanaEquiposSubTipos", "Nuevo Departamento", None))
        self.pushButton_Agregar.setText(_translate("SubVentanaEquiposSubTipos", "Agregar", None))
        self.label_3.setText(_translate("SubVentanaEquiposSubTipos", "Buscar:", None))
        self.label_4.setText(_translate("SubVentanaEquiposSubTipos", "Tipo:", None))
        self.comboBox_Tipo.setItemText(0, _translate("SubVentanaEquiposSubTipos", "Todos", None))
        self.groupBox_Datos.setTitle(_translate("SubVentanaEquiposSubTipos", "Datos del Sub Tipo de Equipo", None))
        self.label_2.setText(_translate("SubVentanaEquiposSubTipos", "Nombre:", None))
        self.pushButton_Guardar.setToolTip(_translate("SubVentanaEquiposSubTipos", "Guardar", None))
        self.pushButton_Guardar.setText(_translate("SubVentanaEquiposSubTipos", "Guardar", None))
        self.pushButton_Borrar.setToolTip(_translate("SubVentanaEquiposSubTipos", "Borrar ", None))
        self.pushButton_Borrar.setText(_translate("SubVentanaEquiposSubTipos", "Borrar", None))
        self.pushButton_Cancelar.setToolTip(_translate("SubVentanaEquiposSubTipos", "Cancelar Edicion", None))
        self.pushButton_Cancelar.setText(_translate("SubVentanaEquiposSubTipos", "Cancelar", None))
        self.label.setText(_translate("SubVentanaEquiposSubTipos", "Tipo", None))
