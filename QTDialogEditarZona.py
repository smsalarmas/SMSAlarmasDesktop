...
# Form implementation generated from reading ui file 'QTDialogEditarZona.ui'
#
...
class Ui_Dialog_EditarZona(object):
    def setupUi(self, Dialog_EditarZona):
        Dialog_EditarZona.setObjectName(_fromUtf8("Dialog_EditarZona"))
        Dialog_EditarZona.resize(300, 300)
        Dialog_EditarZona.setMinimumSize(QtCore.QSize(300, 300))
        Dialog_EditarZona.setMaximumSize(QtCore.QSize(300, 16777215))
        Dialog_EditarZona.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout = QtGui.QGridLayout(Dialog_EditarZona)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.groupBox = QtGui.QGroupBox(Dialog_EditarZona)
        ...
        self.retranslateUi(Dialog_EditarZona)
        QtCore.QMetaObject.connectSlotsByName(Dialog_EditarZona)
        Dialog_EditarZona.setTabOrder(self.lineEdit_Codigo, self.lineEdit_Informacion)
        Dialog_EditarZona.setTabOrder(self.lineEdit_Informacion, self.lineEdit_Ubicacion)
        Dialog_EditarZona.setTabOrder(self.lineEdit_Ubicacion, self.pushButton_AgregarFoto)
        Dialog_EditarZona.setTabOrder(self.pushButton_AgregarFoto, self.pushButton_GuardarZona)

    def retranslateUi(self, Dialog_EditarZona):
        Dialog_EditarZona.setWindowTitle(_translate("Dialog_EditarZona", "Editar Zona", None))
        self.groupBox.setTitle(_translate("Dialog_EditarZona", "Modifique la Informacion de la Zona", None))
        self.lineEdit_Ubicacion.setPlaceholderText(_translate("Dialog_EditarZona", "Lugar de Ubicacion", None))
        self.lineEdit_Informacion.setPlaceholderText(_translate("Dialog_EditarZona", "Informacion de la Zona", None))
        self.pushButton_GuardarZona.setText(_translate("Dialog_EditarZona", "Guardar ", None))
        self.pushButton_AgregarFoto.setText(_translate("Dialog_EditarZona", "Agregar Foto", None))
        self.label_2.setText(_translate("Dialog_EditarZona", "Descripcion:", None))
        self.lineEdit_Codigo.setPlaceholderText(_translate("Dialog_EditarZona", "Numero de Zona", None))
        self.label_3.setText(_translate("Dialog_EditarZona", "Ubicacion:", None))
        self.label.setText(_translate("Dialog_EditarZona", "Codigo:", None))
