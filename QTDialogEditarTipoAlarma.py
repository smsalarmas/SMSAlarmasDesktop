...
# Form implementation generated from reading ui file 'QTDialogEditarTipoAlarma.ui'
#
...
class Ui_Dialog_EditarTipoAlarma(object):
    def setupUi(self, Dialog_EditarTipoAlarma):
        Dialog_EditarTipoAlarma.setObjectName(_fromUtf8("Dialog_EditarTipoAlarma"))
        Dialog_EditarTipoAlarma.resize(300, 300)
        Dialog_EditarTipoAlarma.setMinimumSize(QtCore.QSize(300, 300))
        Dialog_EditarTipoAlarma.setMaximumSize(QtCore.QSize(300, 300))
        Dialog_EditarTipoAlarma.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout = QtGui.QGridLayout(Dialog_EditarTipoAlarma)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.pushButton_Agregar = QtGui.QPushButton(Dialog_EditarTipoAlarma)
        icon = QtGui.QIcon()
        ...
        spacerItem1 = QtGui.QSpacerItem(94, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem1, 1, 0, 1, 1)
        self.groupBox = QtGui.QGroupBox(Dialog_EditarTipoAlarma)
        ...
        self.gridLayout_3.addWidget(self.lineEdit_NombrePanel, 0, 1, 1, 1)
        ...
        self.retranslateUi(Dialog_EditarTipoAlarma)
        QtCore.QMetaObject.connectSlotsByName(Dialog_EditarTipoAlarma)

    def retranslateUi(self, Dialog_EditarTipoAlarma):
        Dialog_EditarTipoAlarma.setWindowTitle(_translate("Dialog_EditarTipoAlarma", "Editar Panel de Alarma", None))
        self.pushButton_Agregar.setText(_translate("Dialog_EditarTipoAlarma", "Agregar", None))
        self.groupBox.setTitle(_translate("Dialog_EditarTipoAlarma", "Modificar Tipo de Alarma", None))
        self.label.setText(_translate("Dialog_EditarTipoAlarma", "Panel", None))
        self.groupBox_2.setTitle(_translate("Dialog_EditarTipoAlarma", "Manuales", None))
        self.label_3.setText(_translate("Dialog_EditarTipoAlarma", "Usuario", None))
        self.label_2.setText(_translate("Dialog_EditarTipoAlarma", "Ayuda", None))
        self.label_4.setText(_translate("Dialog_EditarTipoAlarma", "Programacion", None))
        self.pushButton_BuscarManualAyuda.setText(_translate("Dialog_EditarTipoAlarma", "Buscar", None))
        self.pushButton_BuscarManualUsuario.setText(_translate("Dialog_EditarTipoAlarma", "Buscar", None))
        self.pushButton_BuscarManualProgramacion.setText(_translate("Dialog_EditarTipoAlarma", "Buscar", None))
