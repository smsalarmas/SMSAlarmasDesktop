...
# Form implementation generated from reading ui file 'QTSubVentanaReporteEventoNoDefinido.ui'
#
...
class Ui_SubVentanaReporteEventoNoDefinido(object):
    def setupUi(self, SubVentanaReporteEventoNoDefinido):
        SubVentanaReporteEventoNoDefinido.setObjectName(_fromUtf8("SubVentanaReporteEventoNoDefinido"))
        SubVentanaReporteEventoNoDefinido.resize(732, 550)
        SubVentanaReporteEventoNoDefinido.setMinimumSize(QtCore.QSize(0, 0))
        SubVentanaReporteEventoNoDefinido.setMaximumSize(QtCore.QSize(16777215, 16777215))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/Eventos_no_defi.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SubVentanaReporteEventoNoDefinido.setWindowIcon(icon)
        SubVentanaReporteEventoNoDefinido.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout_2 = QtGui.QGridLayout(SubVentanaReporteEventoNoDefinido)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.frame = QtGui.QFrame(SubVentanaReporteEventoNoDefinido)
...
"color: rgb(255, 255, 255);"))
        ...
        self.groupBox = QtGui.QGroupBox(SubVentanaReporteEventoNoDefinido)
        ...
        self.gridLayout.addWidget(self.tableWidget_Reporte, 1, 1, 1, 5)
        ...
        self.gridLayout.addWidget(self.pushButton_XLS, 0, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_PDF, 0, 4, 1, 1)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem, 0, 1, 1, 3)
        self.gridLayout_2.addWidget(self.groupBox, 1, 0, 1, 1)

        self.retranslateUi(SubVentanaReporteEventoNoDefinido)
        QtCore.QMetaObject.connectSlotsByName(SubVentanaReporteEventoNoDefinido)

    def retranslateUi(self, SubVentanaReporteEventoNoDefinido):
        SubVentanaReporteEventoNoDefinido.setWindowTitle(_translate("SubVentanaReporteEventoNoDefinido", "Reporte de Eventos no definidos", None))
        self.label_5.setText(_translate("SubVentanaReporteEventoNoDefinido", "Reporte de Eventos no definidos", None))
        self.groupBox.setTitle(_translate("SubVentanaReporteEventoNoDefinido", "Lista de Eventos no definidos", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaReporteEventoNoDefinido", "Evento", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(1)
        item.setText(_translate("SubVentanaReporteEventoNoDefinido", "Fecha", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(2)
        item.setText(_translate("SubVentanaReporteEventoNoDefinido", "Trama", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(3)
        item.setText(_translate("SubVentanaReporteEventoNoDefinido", "Cliente", None))
        self.pushButton_XLS.setText(_translate("SubVentanaReporteEventoNoDefinido", "XLS", None))
        self.pushButton_PDF.setText(_translate("SubVentanaReporteEventoNoDefinido", "PDF", None))
