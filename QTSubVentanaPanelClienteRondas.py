...
# Form implementation generated from reading ui file 'QTSubVentanaPanelClienteRondas.ui'
#
...
class Ui_SubVentanaPanelClienteRondas(object):
    def setupUi(self, SubVentanaPanelClienteRondas):
        SubVentanaPanelClienteRondas.setObjectName(_fromUtf8("SubVentanaPanelClienteRondas"))
        SubVentanaPanelClienteRondas.resize(920, 554)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/Lista-Clientes.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SubVentanaPanelClienteRondas.setWindowIcon(icon)
        SubVentanaPanelClienteRondas.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"    color: white;\n"
"}"))
        self.gridLayout_3 = QtGui.QGridLayout(SubVentanaPanelClienteRondas)
        self.gridLayout_3.setObjectName(_fromUtf8("gridLayout_3"))
        self.groupBox = QtGui.QGroupBox(SubVentanaPanelClienteRondas)
        ...
        self.label_Protocolo.setWordWrap(True)
        ...
        self.groupBox_2 = QtGui.QGroupBox(SubVentanaPanelClienteRondas)
        ...
        self.label_FechaInicio.setWordWrap(True)
        ...
        self.widget_11 = QtGui.QWidget(SubVentanaPanelClienteRondas)
...
"color: rgb(255, 255, 255);"))
        ...
        self.gridLayout_26.addWidget(self.label_NombreCuenta, 0, 1, 1, 1)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_26.addItem(spacerItem, 0, 4, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.pushButton_Editar, 0, 5, 1, 1)
        ...
        self.gridLayout_26.addWidget(self.label_MarcaModelo, 0, 3, 1, 1)
        self.gridLayout_3.addWidget(self.widget_11, 0, 0, 1, 2)
        self.tabWidget = QtGui.QTabWidget(SubVentanaPanelClienteRondas)
        ...
        self.pushButton_AgregarPunto = QtGui.QPushButton(self.groupBox_7)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/4-Icone-plus.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_AgregarPunto.setIcon(icon1)
        self.pushButton_AgregarPunto.setDefault(False)
        self.pushButton_AgregarPunto.setObjectName(_fromUtf8("pushButton_AgregarPunto"))
        self.gridLayout_12.addWidget(self.pushButton_AgregarPunto, 0, 3, 1, 1)
        self.lineEdit_BuscarPuntos = QtGui.QLineEdit(self.groupBox_7)
        self.lineEdit_BuscarPuntos.setObjectName(_fromUtf8("lineEdit_BuscarPuntos"))
        self.gridLayout_12.addWidget(self.lineEdit_BuscarPuntos, 0, 1, 1, 1)
        self.tableWidget_Puntos = QtGui.QTableWidget(self.groupBox_7)
        self.tableWidget_Puntos.setObjectName(_fromUtf8("tableWidget_Puntos"))
        self.tableWidget_Puntos.setColumnCount(4)
        self.tableWidget_Puntos.setRowCount(0)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Puntos.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Puntos.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Puntos.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Puntos.setHorizontalHeaderItem(3, item)
        self.gridLayout_12.addWidget(self.tableWidget_Puntos, 1, 0, 1, 4)
        self.gridLayout_5.addWidget(self.groupBox_7, 0, 0, 1, 2)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/connections-512(1).png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_Zonas, icon2, _fromUtf8(""))
        self.tab_Rondas = QtGui.QWidget()
        self.tab_Rondas.setObjectName(_fromUtf8("tab_Rondas"))
        self.gridLayout_15 = QtGui.QGridLayout(self.tab_Rondas)
        self.gridLayout_15.setObjectName(_fromUtf8("gridLayout_15"))
        self.groupBox_11 = QtGui.QGroupBox(self.tab_Rondas)
        self.groupBox_11.setObjectName(_fromUtf8("groupBox_11"))
        self.gridLayout_14 = QtGui.QGridLayout(self.groupBox_11)
        ...
        self.pushButton_AgregarRonda = QtGui.QPushButton(self.groupBox_11)
        self.pushButton_AgregarRonda.setIcon(icon1)
        self.pushButton_AgregarRonda.setDefault(False)
        self.pushButton_AgregarRonda.setObjectName(_fromUtf8("pushButton_AgregarRonda"))
        self.gridLayout_14.addWidget(self.pushButton_AgregarRonda, 0, 3, 1, 1)
        self.lineEdit_BuscarRondas = QtGui.QLineEdit(self.groupBox_11)
        self.lineEdit_BuscarRondas.setObjectName(_fromUtf8("lineEdit_BuscarRondas"))
        self.gridLayout_14.addWidget(self.lineEdit_BuscarRondas, 0, 1, 1, 1)
        self.tableWidget_Rondas = QtGui.QTableWidget(self.groupBox_11)
        self.tableWidget_Rondas.setObjectName(_fromUtf8("tableWidget_Rondas"))
        self.tableWidget_Rondas.setColumnCount(7)
        self.tableWidget_Rondas.setRowCount(0)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Rondas.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Rondas.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Rondas.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Rondas.setHorizontalHeaderItem(3, item)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Rondas.setHorizontalHeaderItem(4, item)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Rondas.setHorizontalHeaderItem(5, item)
        item = QtGui.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.tableWidget_Rondas.setHorizontalHeaderItem(6, item)
        self.gridLayout_14.addWidget(self.tableWidget_Rondas, 1, 0, 1, 4)
        self.gridLayout_15.addWidget(self.groupBox_11, 0, 0, 1, 1)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/calendar-add2.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_Rondas, icon3, _fromUtf8(""))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 87, 114))
...
"}"))
        ...
        self.pushButton_AgregarContacto.setIcon(icon1)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/6-Loupe.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_BuscarAvanzado.setIcon(icon11)
        ...
        self.gridLayout_19.addItem(spacerItem9, 0, 11, 1, 1)
        self.gridLayout_18.addWidget(self.groupBox_10, 0, 0, 1, 1)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/Ven_Rep_avtivaciones.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_Senales, icon12, _fromUtf8(""))
        ...
        self.gridLayout_23.addItem(spacerItem10, 1, 0, 1, 1)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/uncheck.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_BorrarNotaFija.setIcon(icon13)
        ...
        self.pushButton_BorrarNotaTemporal.setIcon(icon13)
        ...
        self.gridLayout_22.addItem(spacerItem11, 3, 0, 1, 3)
        self.gridLayout_20.addWidget(self.groupBox_NotaTemporal, 0, 1, 1, 1)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/note_text-edit.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_Notas, icon14, _fromUtf8(""))
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/Maps.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_Mapa, icon15, _fromUtf8(""))
        ...
        self.gridLayout_38.addItem(spacerItem12, 0, 0, 1, 1)
        self.pushButton_AgregarCCTV = QtGui.QPushButton(self.groupBox_4)
        self.pushButton_AgregarCCTV.setIcon(icon1)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/CCTVICON.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_Camaras, icon16, _fromUtf8(""))
        self.tab_Equipos = QtGui.QWidget()
        self.tab_Equipos.setObjectName(_fromUtf8("tab_Equipos"))
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/Departamentos3.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_Equipos, icon17, _fromUtf8(""))
        self.gridLayout_3.addWidget(self.tabWidget, 3, 0, 1, 2)

        self.retranslateUi(SubVentanaPanelClienteRondas)
        self.tabWidget.setCurrentIndex(0)
        self.toolBox_UsuariosEventos.setCurrentIndex(0)
        self.comboBox_TipoNotificacion.setCurrentIndex(-1)
        QtCore.QMetaObject.connectSlotsByName(SubVentanaPanelClienteRondas)

    def retranslateUi(self, SubVentanaPanelClienteRondas):
        SubVentanaPanelClienteRondas.setWindowTitle(_translate("SubVentanaPanelClienteRondas", "Panel del Cliente", None))
        self.groupBox.setTitle(_translate("SubVentanaPanelClienteRondas", "Datos del Cliente", None))
        self.label_Empresa.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_Email.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_6.setText(_translate("SubVentanaPanelClienteRondas", "Tipo de Cliente:", None))
        self.label_TipoCliente.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_7.setText(_translate("SubVentanaPanelClienteRondas", "Protocolo:", None))
        self.label_Protocolo.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_ClaveMaster.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_3.setText(_translate("SubVentanaPanelClienteRondas", "Codigo Fiscal:", None))
        self.label_CodigoFiscal.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_2.setText(_translate("SubVentanaPanelClienteRondas", "Codigo Cliente:", None))
        self.label_CodigoCliente.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_5.setText(_translate("SubVentanaPanelClienteRondas", "Email:", None))
        self.label_4.setText(_translate("SubVentanaPanelClienteRondas", "Clave Master:", None))
        self.label.setText(_translate("SubVentanaPanelClienteRondas", "Empresa:", None))
        self.groupBox_2.setTitle(_translate("SubVentanaPanelClienteRondas", " Datos Adicionales", None))
        self.label_Referencia.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_TelefonoLocal.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_19.setText(_translate("SubVentanaPanelClienteRondas", "Fecha Inicio:", None))
        self.label_UltimoEvento.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_18.setText(_translate("SubVentanaPanelClienteRondas", "Telefono Local:", None))
        self.label_15.setText(_translate("SubVentanaPanelClienteRondas", "Ciudad:", None))
        self.label_Direccion.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_Ciudad.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_16.setText(_translate("SubVentanaPanelClienteRondas", "Direccion:", None))
        self.label_17.setText(_translate("SubVentanaPanelClienteRondas", "Referencia:", None))
        self.label_20.setText(_translate("SubVentanaPanelClienteRondas", "Ultimo Evento:", None))
        self.label_FechaInicio.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_21.setText(_translate("SubVentanaPanelClienteRondas", "Ultimo Reporte:", None))
        self.label_UltimoReporte.setText(_translate("SubVentanaPanelClienteRondas", "----------------------", None))
        self.label_NombreCuenta.setText(_translate("SubVentanaPanelClienteRondas", "-------------------------------------------------------", None))
        self.pushButton_Editar.setText(_translate("SubVentanaPanelClienteRondas", "Editar", None))
        self.label_MarcaModelo.setText(_translate("SubVentanaPanelClienteRondas", "Marca / Modelo", None))
        self.groupBox_7.setTitle(_translate("SubVentanaPanelClienteRondas", "Lista de Puntos", None))
        self.label_11.setText(_translate("SubVentanaPanelClienteRondas", "Buscar:", None))
        self.pushButton_AgregarPunto.setText(_translate("SubVentanaPanelClienteRondas", "Agregar", None))
        item = self.tableWidget_Puntos.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaPanelClienteRondas", "ID", None))
        item = self.tableWidget_Puntos.horizontalHeaderItem(1)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Descripcion", None))
        item = self.tableWidget_Puntos.horizontalHeaderItem(2)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Ubicacion", None))
        item = self.tableWidget_Puntos.horizontalHeaderItem(3)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Acciones", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Zonas), _translate("SubVentanaPanelClienteRondas", "Puntos", None))
        self.groupBox_11.setTitle(_translate("SubVentanaPanelClienteRondas", "Lista de Rondas", None))
        self.label_27.setText(_translate("SubVentanaPanelClienteRondas", "Buscar:", None))
        self.pushButton_AgregarRonda.setText(_translate("SubVentanaPanelClienteRondas", "Agregar", None))
        item = self.tableWidget_Rondas.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Nombre", None))
        item = self.tableWidget_Rondas.horizontalHeaderItem(1)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Tipo", None))
        item = self.tableWidget_Rondas.horizontalHeaderItem(2)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Hora Inicio", None))
        item = self.tableWidget_Rondas.horizontalHeaderItem(3)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Hora Fin", None))
        item = self.tableWidget_Rondas.horizontalHeaderItem(4)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Tolerancia", None))
        item = self.tableWidget_Rondas.horizontalHeaderItem(5)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Calendario", None))
        item = self.tableWidget_Rondas.horizontalHeaderItem(6)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Acciones", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Rondas), _translate("SubVentanaPanelClienteRondas", "Rondas", None))
        self.groupBox_8.setTitle(_translate("SubVentanaPanelClienteRondas", "Lista de Usuarios", None))
        self.label_BuscarUsuarios.setText(_translate("SubVentanaPanelClienteRondas", "Buscar: ", None))
        self.pushButton_AgregarUsuario.setText(_translate("SubVentanaPanelClienteRondas", "Agregar", None))
        ...
        item.setText(_translate("SubVentanaPanelClienteRondas", "Correo", None))
        item = self.tableWidget_Usuarios.horizontalHeaderItem(3)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Movil", None))
        item = self.tableWidget_Usuarios.horizontalHeaderItem(4)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Acciones", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Usuarios), _translate("SubVentanaPanelClienteRondas", "Usuarios", None))
        self.groupBox_5.setTitle(_translate("SubVentanaPanelClienteRondas", "Usuarios con Eventos", None))
        self.toolBox_UsuariosEventos.setItemText(self.toolBox_UsuariosEventos.indexOf(self.page), _translate("SubVentanaPanelClienteRondas", "Usuarios", None))
        self.groupBox_3.setTitle(_translate("SubVentanaPanelClienteRondas", "Asignacion de Eventos", None))
        self.label_8.setText(_translate("SubVentanaPanelClienteRondas", "Usuarios", None))
        self.label_9.setText(_translate("SubVentanaPanelClienteRondas", "Tipo", None))
        self.comboBox_TipoNotificacion.setItemText(0, _translate("SubVentanaPanelClienteRondas", "SMS", None))
        self.comboBox_TipoNotificacion.setItemText(1, _translate("SubVentanaPanelClienteRondas", "Email", None))
        self.label_10.setText(_translate("SubVentanaPanelClienteRondas", "Planes", None))
        item = self.tableWidget_EventosPlan.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Codigo Evento", None))
        item = self.tableWidget_EventosPlan.horizontalHeaderItem(1)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Descripcion", None))
        self.pushButton_AsignarPlan.setText(_translate("SubVentanaPanelClienteRondas", "Guardar", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Notificaciones), _translate("SubVentanaPanelClienteRondas", "Notificaciones", None))
        self.groupBox_9.setTitle(_translate("SubVentanaPanelClienteRondas", "Lista de Notifaciones", None))
        self.pushButton_ExportarSMSXLS.setText(_translate("SubVentanaPanelClienteRondas", "EXCEL", None))
        item = self.tableWidget_SMS.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Movil", None))
        item = self.tableWidget_SMS.horizontalHeaderItem(1)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Hora", None))
        item = self.tableWidget_SMS.horizontalHeaderItem(2)
        item.setText(_translate("SubVentanaPanelClienteRondas", "SMS", None))
        self.pushButton_ExportarSMSPDF.setText(_translate("SubVentanaPanelClienteRondas", "PDF", None))
        self.label_FechaHistorialSMS.setText(_translate("SubVentanaPanelClienteRondas", "Fecha: ", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_SMS), _translate("SubVentanaPanelClienteRondas", "SMS", None))
        self.groupBox_6.setTitle(_translate("SubVentanaPanelClienteRondas", "Lista de Emergencia", None))
        self.label_13.setText(_translate("SubVentanaPanelClienteRondas", "Buscar:", None))
        self.pushButton_AgregarContacto.setText(_translate("SubVentanaPanelClienteRondas", "Agregar", None))
        item = self.tableWidget_Contactos.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Numero", None))
        item = self.tableWidget_Contactos.horizontalHeaderItem(1)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Descripcion", None))
        item = self.tableWidget_Contactos.horizontalHeaderItem(2)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Observacion", None))
        item = self.tableWidget_Contactos.horizontalHeaderItem(3)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Acciones", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Contactos), _translate("SubVentanaPanelClienteRondas", "Contactos", None))
        self.groupBox_10.setTitle(_translate("SubVentanaPanelClienteRondas", "Lista de Señales", None))
        self.pushButton_SenalesExportarPDF.setText(_translate("SubVentanaPanelClienteRondas", "PDF", None))
        self.label_22.setText(_translate("SubVentanaPanelClienteRondas", "Eventos", None))
        self.label_FechaHistorialSenales.setText(_translate("SubVentanaPanelClienteRondas", "Fecha: ", None))
        self.pushButton_SenalesExportarXLS.setText(_translate("SubVentanaPanelClienteRondas", "EXCEL", None))
        item = self.tableWidget_Senales.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Evento", None))
        item = self.tableWidget_Senales.horizontalHeaderItem(1)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Usuario/Zonas", None))
        item = self.tableWidget_Senales.horizontalHeaderItem(2)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Fecha Recepcion", None))
        item = self.tableWidget_Senales.horizontalHeaderItem(3)
        item.setText(_translate("SubVentanaPanelClienteRondas", "Fecha Procesada", None))
        self.label_12.setText(_translate("SubVentanaPanelClienteRondas", "Desde:", None))
        self.pushButton_SelectorBusqueda.setText(_translate("SubVentanaPanelClienteRondas", "Busqueda Avanzada", None))
        self.label_14.setText(_translate("SubVentanaPanelClienteRondas", "Hasta:", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Senales), _translate("SubVentanaPanelClienteRondas", "Historial", None))
        self.groupBox_NotaFija.setTitle(_translate("SubVentanaPanelClienteRondas", "Nota Fija", None))
        self.pushButton_AsignarNotaFija.setText(_translate("SubVentanaPanelClienteRondas", "Guardar", None))
        self.pushButton_BorrarNotaFija.setText(_translate("SubVentanaPanelClienteRondas", "Borrar", None))
        self.groupBox_NotaTemporal.setTitle(_translate("SubVentanaPanelClienteRondas", "Notas Temporales", None))
        self.label_Hasta.setText(_translate("SubVentanaPanelClienteRondas", "Hasta", None))
        self.label_Desde.setText(_translate("SubVentanaPanelClienteRondas", "Desde", None))
        self.pushButton_BorrarNotaTemporal.setText(_translate("SubVentanaPanelClienteRondas", "Borrar", None))
        self.pushButton_AsignarNotaTemporal.setText(_translate("SubVentanaPanelClienteRondas", "Guardar", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Notas), _translate("SubVentanaPanelClienteRondas", "Notas", None))
        self.groupBox_Mapa.setTitle(_translate("SubVentanaPanelClienteRondas", "Ubicacion del Cliente en el Mapa", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Mapa), _translate("SubVentanaPanelClienteRondas", "Mapa", None))
        self.groupBox_4.setTitle(_translate("SubVentanaPanelClienteRondas", "Lista de Dispositivos de CCTV", None))
        self.pushButton_AgregarCCTV.setText(_translate("SubVentanaPanelClienteRondas", "Agregar", None))
        self.treeWidget_Camaras.headerItem().setText(0, _translate("SubVentanaPanelClienteRondas", "Descripcion", None))
        self.treeWidget_Camaras.headerItem().setText(1, _translate("SubVentanaPanelClienteRondas", "Tipo", None))
        self.treeWidget_Camaras.headerItem().setText(2, _translate("SubVentanaPanelClienteRondas", "Modo", None))
        self.treeWidget_Camaras.headerItem().setText(3, _translate("SubVentanaPanelClienteRondas", "Acciones", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Camaras), _translate("SubVentanaPanelClienteRondas", "Camaras", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_Equipos), _translate("SubVentanaPanelClienteRondas", "Equipos", None))
