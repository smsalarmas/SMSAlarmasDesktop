...
# Form implementation generated from reading ui file 'QTSubVentanaReporteGruposSenales.ui'
#
...
class Ui_SubVentanaReporteGruposSenales(object):
    def setupUi(self, SubVentanaReporteGruposSenales):
        SubVentanaReporteGruposSenales.setObjectName(_fromUtf8("SubVentanaReporteGruposSenales"))
        SubVentanaReporteGruposSenales.resize(712, 485)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/Grupo_Señlales.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SubVentanaReporteGruposSenales.setWindowIcon(icon)
        SubVentanaReporteGruposSenales.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout = QtGui.QGridLayout(SubVentanaReporteGruposSenales)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.frame = QtGui.QFrame(SubVentanaReporteGruposSenales)
...
"color: rgb(255, 255, 255);"))
        ...
        self.groupBox = QtGui.QGroupBox(SubVentanaReporteGruposSenales)
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.gridLayout_2 = QtGui.QGridLayout(self.groupBox)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.widget_Grafico = QtGui.QWidget(self.groupBox)
        self.widget_Grafico.setObjectName(_fromUtf8("widget_Grafico"))
        self.gridLayout_2.addWidget(self.widget_Grafico, 1, 1, 1, 1)
        ...
        self.retranslateUi(SubVentanaReporteGruposSenales)
        QtCore.QMetaObject.connectSlotsByName(SubVentanaReporteGruposSenales)

    def retranslateUi(self, SubVentanaReporteGruposSenales):
        SubVentanaReporteGruposSenales.setWindowTitle(_translate("SubVentanaReporteGruposSenales", "Reporte de Grupos de Señales", None))
        self.label.setText(_translate("SubVentanaReporteGruposSenales", "Reporte de Grupos de Señales", None))
        self.groupBox.setTitle(_translate("SubVentanaReporteGruposSenales", "Reporte Detallado", None))
        self.label_3.setText(_translate("SubVentanaReporteGruposSenales", "Desde:", None))
        self.label_4.setText(_translate("SubVentanaReporteGruposSenales", "Hasta:", None))
        self.pushButton_GenerarReporte.setText(_translate("SubVentanaReporteGruposSenales", "Buscar", None))
