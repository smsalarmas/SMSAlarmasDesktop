...
# Form implementation generated from reading ui file 'QTSubVentanaReporteCantidadSMS.ui'
#
...
class Ui_SubVentanaReporteCantidadSMS(object):
    def setupUi(self, SubVentanaReporteCantidadSMS):
        SubVentanaReporteCantidadSMS.setObjectName(_fromUtf8("SubVentanaReporteCantidadSMS"))
        SubVentanaReporteCantidadSMS.resize(728, 420)
        SubVentanaReporteCantidadSMS.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout = QtGui.QGridLayout(SubVentanaReporteCantidadSMS)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.groupBox = QtGui.QGroupBox(SubVentanaReporteCantidadSMS)
        ...
        self.pushButton_PDF.setIcon(icon)
        ...
        self.frame = QtGui.QFrame(SubVentanaReporteCantidadSMS)
...
"color: rgb(255, 255, 255);"))
        ...
        self.retranslateUi(SubVentanaReporteCantidadSMS)
        QtCore.QMetaObject.connectSlotsByName(SubVentanaReporteCantidadSMS)

    def retranslateUi(self, SubVentanaReporteCantidadSMS):
        SubVentanaReporteCantidadSMS.setWindowTitle(_translate("SubVentanaReporteCantidadSMS", "Reporte de Cantidad de SMS", None))
        self.groupBox.setTitle(_translate("SubVentanaReporteCantidadSMS", "Reporte Detallado", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaReporteCantidadSMS", "ID", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(1)
        item.setText(_translate("SubVentanaReporteCantidadSMS", "Nombre", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(2)
        item.setText(_translate("SubVentanaReporteCantidadSMS", "Cant SMS", None))
        item = self.tableWidget_Reporte.horizontalHeaderItem(3)
        item.setText(_translate("SubVentanaReporteCantidadSMS", "Acciones", None))
        self.label_3.setText(_translate("SubVentanaReporteCantidadSMS", "Desde:", None))
        self.label_4.setText(_translate("SubVentanaReporteCantidadSMS", "Hasta:", None))
        self.pushButton_GenerarReporte.setText(_translate("SubVentanaReporteCantidadSMS", "Generar", None))
        self.pushButton_PDF.setText(_translate("SubVentanaReporteCantidadSMS", "PDF", None))
        self.pushButton_XLS.setText(_translate("SubVentanaReporteCantidadSMS", "XLS", None))
        self.label.setText(_translate("SubVentanaReporteCantidadSMS", " Reporte SMS Total por Cliente ", None))
