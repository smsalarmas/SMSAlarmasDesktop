...
# Form implementation generated from reading ui file 'QTDialogAgregarCCTV.ui'
#
...
class Ui_Dialog_AgregarCCTV(object):
    def setupUi(self, Dialog_AgregarCCTV):
        Dialog_AgregarCCTV.setObjectName(_fromUtf8("Dialog_AgregarCCTV"))
        Dialog_AgregarCCTV.resize(419, 506)
        Dialog_AgregarCCTV.setMinimumSize(QtCore.QSize(419, 506))
        Dialog_AgregarCCTV.setMaximumSize(QtCore.QSize(419, 506))
        Dialog_AgregarCCTV.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout_2 = QtGui.QGridLayout(Dialog_AgregarCCTV)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem, 1, 2, 1, 1)
        self.pushButton_AgregarCCTV = QtGui.QPushButton(Dialog_AgregarCCTV)
        icon = QtGui.QIcon()
        ...
        self.groupBox = QtGui.QGroupBox(Dialog_AgregarCCTV)
        ...
        self.gridLayout.addWidget(self.comboBox_ModoRegistro, 0, 1, 1, 1)
        self.label = QtGui.QLabel(self.groupBox)
        self.label.setObjectName(_fromUtf8("label"))
        self.gridLayout.addWidget(self.label, 1, 0, 1, 1)
        self.lineEdit_Descripcion = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_Descripcion.setMaxLength(150)
        ...
        self.gridLayout.addWidget(self.comboBox_Tipo, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_Marca, 3, 1, 1, 1)
        ...
        self.lineEdit_Canal.setMaxLength(3)
        ...
        self.lineEdit_DescripcionCanal.setMaxLength(100)
        ...
        self.gridLayout.addWidget(self.groupBox_RTSP, 9, 0, 1, 2)
        self.gridLayout_2.addWidget(self.groupBox, 0, 0, 1, 3)

        self.retranslateUi(Dialog_AgregarCCTV)
        QtCore.QMetaObject.connectSlotsByName(Dialog_AgregarCCTV)
        Dialog_AgregarCCTV.setTabOrder(self.lineEdit_Descripcion, self.lineEdit_IP)
        Dialog_AgregarCCTV.setTabOrder(self.lineEdit_IP, self.lineEdit_Puerto)
        Dialog_AgregarCCTV.setTabOrder(self.lineEdit_Puerto, self.pushButton_AgregarCCTV)

    def retranslateUi(self, Dialog_AgregarCCTV):
        Dialog_AgregarCCTV.setWindowTitle(_translate("Dialog_AgregarCCTV", "Agregar CCTV", None))
        self.pushButton_AgregarCCTV.setText(_translate("Dialog_AgregarCCTV", "Guardar", None))
        self.groupBox.setTitle(_translate("Dialog_AgregarCCTV", "Agrege la informacion de CCTV", None))
        self.label_2.setText(_translate("Dialog_AgregarCCTV", "Modo de Registro:", None))
        self.label.setText(_translate("Dialog_AgregarCCTV", "Descripcion:", None))
        self.label_3.setText(_translate("Dialog_AgregarCCTV", "Tipo:", None))
        self.label_4.setText(_translate("Dialog_AgregarCCTV", "Marca:", None))
        self.label_5.setText(_translate("Dialog_AgregarCCTV", "Modelo:", None))
        self.label_6.setText(_translate("Dialog_AgregarCCTV", "IP / DNS:", None))
        self.label_7.setText(_translate("Dialog_AgregarCCTV", "Puerto:", None))
        self.label_8.setText(_translate("Dialog_AgregarCCTV", "Usuario:", None))
        self.label_9.setText(_translate("Dialog_AgregarCCTV", "Clave:", None))
        self.label_23.setText(_translate("Dialog_AgregarCCTV", "Configurar Camaras RTSP", None))
        self.label_Camara.setText(_translate("Dialog_AgregarCCTV", "Camara:", None))
        self.lineEdit_Canal.setPlaceholderText(_translate("Dialog_AgregarCCTV", "Canal", None))
        self.lineEdit_DescripcionCanal.setPlaceholderText(_translate("Dialog_AgregarCCTV", "Descripcion", None))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Dialog_AgregarCCTV", "Canal", None))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Dialog_AgregarCCTV", "Descripcion", None))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog_AgregarCCTV", "Borrar", None))
