...
# Form implementation generated from reading ui file 'QTDialogAgregarPunto.ui'
#
...
class Ui_Dialog_AgregarPunto(object):
    def setupUi(self, Dialog_AgregarPunto):
        Dialog_AgregarPunto.setObjectName(_fromUtf8("Dialog_AgregarPunto"))
        Dialog_AgregarPunto.resize(300, 300)
        Dialog_AgregarPunto.setMinimumSize(QtCore.QSize(300, 300))
        Dialog_AgregarPunto.setMaximumSize(QtCore.QSize(300, 16777215))
        Dialog_AgregarPunto.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout = QtGui.QGridLayout(Dialog_AgregarPunto)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.groupBox = QtGui.QGroupBox(Dialog_AgregarPunto)
        ...
        self.pushButton_GuardarPunto.setIcon(icon1)
        ...
        self.retranslateUi(Dialog_AgregarPunto)
        QtCore.QMetaObject.connectSlotsByName(Dialog_AgregarPunto)
        Dialog_AgregarPunto.setTabOrder(self.lineEdit_Codigo, self.lineEdit_Informacion)
        Dialog_AgregarPunto.setTabOrder(self.lineEdit_Informacion, self.lineEdit_Ubicacion)

    def retranslateUi(self, Dialog_AgregarPunto):
        Dialog_AgregarPunto.setWindowTitle(_translate("Dialog_AgregarPunto", "Agregar Punto", None))
        self.groupBox.setTitle(_translate("Dialog_AgregarPunto", "Agregue la Informacion del Punto", None))
        self.label.setText(_translate("Dialog_AgregarPunto", "Codigo:", None))
        self.lineEdit_Codigo.setPlaceholderText(_translate("Dialog_AgregarPunto", "Numero de Zona", None))
        self.label_2.setText(_translate("Dialog_AgregarPunto", "Descripcion:", None))
        self.lineEdit_Informacion.setPlaceholderText(_translate("Dialog_AgregarPunto", "Informacion de la Zona", None))
        self.label_3.setText(_translate("Dialog_AgregarPunto", "Ubicacion:", None))
        self.lineEdit_Ubicacion.setPlaceholderText(_translate("Dialog_AgregarPunto", "Lugar de Ubicacion", None))
        self.pushButton_AgregarFoto.setText(_translate("Dialog_AgregarPunto", "Agregar Foto", None))
        self.pushButton_GuardarPunto.setText(_translate("Dialog_AgregarPunto", "Guardar", None))
