...
# Form implementation generated from reading ui file 'QTSubVentanaTiposEquipos.ui'
#
...
class Ui_SubVentanaEquiposTipos(object):
    def setupUi(self, SubVentanaEquiposTipos):
        SubVentanaEquiposTipos.setObjectName(_fromUtf8("SubVentanaEquiposTipos"))
        ...
        SubVentanaEquiposTipos.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"}"))
        ...
        SubVentanaEquiposTipos.setTabOrder(self.lineEdit_Buscar, self.tableWidget_Lista)
        SubVentanaEquiposTipos.setTabOrder(self.tableWidget_Lista, self.pushButton_Agregar)
        SubVentanaEquiposTipos.setTabOrder(self.pushButton_Agregar, self.lineEdit_Nombre)
        SubVentanaEquiposTipos.setTabOrder(self.lineEdit_Nombre, self.pushButton_Guardar)
        SubVentanaEquiposTipos.setTabOrder(self.pushButton_Guardar, self.pushButton_Borrar)
        SubVentanaEquiposTipos.setTabOrder(self.pushButton_Borrar, self.pushButton_Cancelar)

    def retranslateUi(self, SubVentanaEquiposTipos):
        SubVentanaEquiposTipos.setWindowTitle(_translate("SubVentanaEquiposTipos", "Administrar Tipos de Equipos", None))
        self.groupBox_4.setTitle(_translate("SubVentanaEquiposTipos", "Lista de Tipos de Equipos", None))
        item = self.tableWidget_Lista.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaEquiposTipos", "Descripcion", None))
        self.pushButton_Agregar.setToolTip(_translate("SubVentanaEquiposTipos", "Nuevo Departamento", None))
        self.pushButton_Agregar.setText(_translate("SubVentanaEquiposTipos", "Agregar", None))
        self.label_3.setText(_translate("SubVentanaEquiposTipos", "Buscar:", None))
        self.groupBox_Datos.setTitle(_translate("SubVentanaEquiposTipos", "Datos del Tipo de Equipo", None))
        self.label_2.setText(_translate("SubVentanaEquiposTipos", "Nombre:", None))
        self.pushButton_Guardar.setToolTip(_translate("SubVentanaEquiposTipos", "Guardar", None))
        self.pushButton_Guardar.setText(_translate("SubVentanaEquiposTipos", "Guardar", None))
        self.pushButton_Borrar.setToolTip(_translate("SubVentanaEquiposTipos", "Borrar ", None))
        self.pushButton_Borrar.setText(_translate("SubVentanaEquiposTipos", "Borrar", None))
        self.pushButton_Cancelar.setToolTip(_translate("SubVentanaEquiposTipos", "Cancelar Edicion", None))
        self.pushButton_Cancelar.setText(_translate("SubVentanaEquiposTipos", "Cancelar", None))
