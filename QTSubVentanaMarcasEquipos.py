...
# Form implementation generated from reading ui file 'QTSubVentanaMarcasEquipos.ui'
#
...
class Ui_SubVentanaEquiposMarcas(object):
    def setupUi(self, SubVentanaEquiposMarcas):
        SubVentanaEquiposMarcas.setObjectName(_fromUtf8("SubVentanaEquiposMarcas"))
        SubVentanaEquiposMarcas.resize(338, 505)
        SubVentanaEquiposMarcas.setMinimumSize(QtCore.QSize(338, 505))
        SubVentanaEquiposMarcas.setMaximumSize(QtCore.QSize(338, 505))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/iconos/ico/Departamentos3.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        SubVentanaEquiposMarcas.setWindowIcon(icon)
        SubVentanaEquiposMarcas.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout_2 = QtGui.QGridLayout(SubVentanaEquiposMarcas)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.groupBox_4 = QtGui.QGroupBox(SubVentanaEquiposMarcas)
        ...
        self.groupBox_Datos = QtGui.QGroupBox(SubVentanaEquiposMarcas)
        ...
        self.retranslateUi(SubVentanaEquiposMarcas)
        QtCore.QMetaObject.connectSlotsByName(SubVentanaEquiposMarcas)
        SubVentanaEquiposMarcas.setTabOrder(self.lineEdit_Buscar, self.tableWidget_Lista)
        SubVentanaEquiposMarcas.setTabOrder(self.tableWidget_Lista, self.pushButton_Agregar)
        SubVentanaEquiposMarcas.setTabOrder(self.pushButton_Agregar, self.lineEdit_Nombre)
        SubVentanaEquiposMarcas.setTabOrder(self.lineEdit_Nombre, self.pushButton_Guardar)
        SubVentanaEquiposMarcas.setTabOrder(self.pushButton_Guardar, self.pushButton_Borrar)
        SubVentanaEquiposMarcas.setTabOrder(self.pushButton_Borrar, self.pushButton_Cancelar)

    def retranslateUi(self, SubVentanaEquiposMarcas):
        SubVentanaEquiposMarcas.setWindowTitle(_translate("SubVentanaEquiposMarcas", "Administrar Marcas de Equipos", None))
        self.groupBox_4.setTitle(_translate("SubVentanaEquiposMarcas", "Lista de Marcas", None))
        item = self.tableWidget_Lista.horizontalHeaderItem(0)
        item.setText(_translate("SubVentanaEquiposMarcas", "Descripcion", None))
        self.pushButton_Agregar.setToolTip(_translate("SubVentanaEquiposMarcas", "Nuevo Departamento", None))
        self.pushButton_Agregar.setText(_translate("SubVentanaEquiposMarcas", "Agregar", None))
        self.label_3.setText(_translate("SubVentanaEquiposMarcas", "Buscar:", None))
        self.groupBox_Datos.setTitle(_translate("SubVentanaEquiposMarcas", "Datos de la Marca", None))
        self.label_2.setText(_translate("SubVentanaEquiposMarcas", "Nombre:", None))
        self.pushButton_Guardar.setToolTip(_translate("SubVentanaEquiposMarcas", "Guardar", None))
        self.pushButton_Guardar.setText(_translate("SubVentanaEquiposMarcas", "Guardar", None))
        self.pushButton_Borrar.setToolTip(_translate("SubVentanaEquiposMarcas", "Borrar ", None))
        self.pushButton_Borrar.setText(_translate("SubVentanaEquiposMarcas", "Borrar", None))
        self.pushButton_Cancelar.setToolTip(_translate("SubVentanaEquiposMarcas", "Cancelar Edicion", None))
        self.pushButton_Cancelar.setText(_translate("SubVentanaEquiposMarcas", "Cancelar", None))
