...
# Form implementation generated from reading ui file 'QTDialogAgregarHorario.ui'
#
...
class Ui_Dialog_AgregarHorarios(object):
    def setupUi(self, Dialog_AgregarHorarios):
        Dialog_AgregarHorarios.setObjectName(_fromUtf8("Dialog_AgregarHorarios"))
        Dialog_AgregarHorarios.resize(300, 250)
        Dialog_AgregarHorarios.setMinimumSize(QtCore.QSize(300, 250))
        Dialog_AgregarHorarios.setMaximumSize(QtCore.QSize(300, 250))
        Dialog_AgregarHorarios.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout = QtGui.QGridLayout(Dialog_AgregarHorarios)
        ...
        self.pushButton_Agregar = QtGui.QPushButton(Dialog_AgregarHorarios)
        ...
        self.pushButton_Agregar.setStyleSheet(_fromUtf8(""))
        icon = QtGui.QIcon()
        ...
        self.pushButton_Agregar.setShortcut(_fromUtf8(""))
        ...
        self.groupBox = QtGui.QGroupBox(Dialog_AgregarHorarios)
        ...
        self.retranslateUi(Dialog_AgregarHorarios)
        QtCore.QMetaObject.connectSlotsByName(Dialog_AgregarHorarios)

    def retranslateUi(self, Dialog_AgregarHorarios):
        Dialog_AgregarHorarios.setWindowTitle(_translate("Dialog_AgregarHorarios", "Agregar Horario", None))
        self.pushButton_Agregar.setText(_translate("Dialog_AgregarHorarios", "Agregar  ", None))
        self.groupBox.setTitle(_translate("Dialog_AgregarHorarios", "Ingrese la informacion del Horario", None))
        self.label.setText(_translate("Dialog_AgregarHorarios", "Dia", None))
        self.comboBox_Dias.setItemText(0, _translate("Dialog_AgregarHorarios", "Lunes", None))
        self.comboBox_Dias.setItemText(1, _translate("Dialog_AgregarHorarios", "Martes", None))
        self.comboBox_Dias.setItemText(2, _translate("Dialog_AgregarHorarios", "Miercoles", None))
        self.comboBox_Dias.setItemText(3, _translate("Dialog_AgregarHorarios", "Jueves", None))
        self.comboBox_Dias.setItemText(4, _translate("Dialog_AgregarHorarios", "Viernes", None))
        self.comboBox_Dias.setItemText(5, _translate("Dialog_AgregarHorarios", "Sabado", None))
        self.comboBox_Dias.setItemText(6, _translate("Dialog_AgregarHorarios", "Domingo", None))
        self.comboBox_Dias.setItemText(7, _translate("Dialog_AgregarHorarios", "Feriados", None))
        self.label_2.setText(_translate("Dialog_AgregarHorarios", "Hora Apertura", None))
        self.label_3.setText(_translate("Dialog_AgregarHorarios", "Tolerancia Apertura", None))
        self.label_4.setText(_translate("Dialog_AgregarHorarios", "Hora Cierre", None))
        self.label_5.setText(_translate("Dialog_AgregarHorarios", "Tolerancia Cierre", None))
