...
# Form implementation generated from reading ui file 'QTDialogEditarRonda.ui'
#
...
class Ui_Dialog_EditarRonda(object):
    def setupUi(self, Dialog_EditarRonda):
        Dialog_EditarRonda.setObjectName(_fromUtf8("Dialog_EditarRonda"))
        Dialog_EditarRonda.resize(604, 467)
        Dialog_EditarRonda.setMinimumSize(QtCore.QSize(0, 0))
        Dialog_EditarRonda.setMaximumSize(QtCore.QSize(16777215, 16777215))
        Dialog_EditarRonda.setStyleSheet(_fromUtf8("QTableView {\n"
"    color: #4d4e51;\n"
...
"\n"
"}"))
        self.gridLayout = QtGui.QGridLayout(Dialog_EditarRonda)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.groupBox = QtGui.QGroupBox(Dialog_EditarRonda)
        ...
        self.groupBox_2 = QtGui.QGroupBox(Dialog_EditarRonda)
        ...
        self.pushButton_GuardarRonda = QtGui.QPushButton(Dialog_EditarRonda)
        icon = QtGui.QIcon()
        ...
        self.retranslateUi(Dialog_EditarRonda)
        QtCore.QMetaObject.connectSlotsByName(Dialog_EditarRonda)

    def retranslateUi(self, Dialog_EditarRonda):
        Dialog_EditarRonda.setWindowTitle(_translate("Dialog_EditarRonda", "Modificar Ronda", None))
        self.groupBox.setTitle(_translate("Dialog_EditarRonda", "Modifique la Informacion de la Ronda", None))
        self.label_13.setText(_translate("Dialog_EditarRonda", "Minutos", None))
        self.label_9.setText(_translate("Dialog_EditarRonda", "Calendario:", None))
        self.label_2.setText(_translate("Dialog_EditarRonda", "Tipo:", None))
        self.label_3.setText(_translate("Dialog_EditarRonda", "Hora Inicio:", None))
        self.lineEdit_NombreRonda.setPlaceholderText(_translate("Dialog_EditarRonda", "Nombre de la Ronda", None))
        self.label.setText(_translate("Dialog_EditarRonda", "Nombre", None))
        self.label_10.setText(_translate("Dialog_EditarRonda", "Hora Fin:", None))
        self.label_6.setText(_translate("Dialog_EditarRonda", "Tolerancia:", None))
        self.groupBox_Repetir.setTitle(_translate("Dialog_EditarRonda", "Auto Crear", None))
        self.label_15.setText(_translate("Dialog_EditarRonda", "Calculo de Rondas a crear", None))
        self.label_4.setText(_translate("Dialog_EditarRonda", "Repetir Hasta:", None))
        self.label_5.setText(_translate("Dialog_EditarRonda", "Repetir cada:", None))
        self.label_7.setText(_translate("Dialog_EditarRonda", "Minutos", None))
        self.label_14.setText(_translate("Dialog_EditarRonda", "Repetir:", None))
        self.checkBox.setText(_translate("Dialog_EditarRonda", "Repetir Ronda", None))
        self.groupBox_2.setTitle(_translate("Dialog_EditarRonda", "Administracion de Puntos", None))
        self.label_8.setText(_translate("Dialog_EditarRonda", "Puntos Disponibles", None))
        self.label_12.setText(_translate("Dialog_EditarRonda", "Puntos Asignados a la Ronda", None))
        self.pushButton_GuardarRonda.setText(_translate("Dialog_EditarRonda", "Guardar", None))
